        ...
        sets: [
            {
                ...
                weight: 20,
                notes: "Dont go too deep here, bring bar down to about eye level and drive back up."
            },
            {
                repLow: 10,
                repHi: 12,
    ...
    },
    {
        ...
        sets: [
            ...
            },
            {
                ...
                tempo: "2 second eccentrics",
                weight: 60,
                notes: "Go lighter than set 1 in this set, focus on form and maximum chest contraction"
            },
        ]
    },
    {
        ...
        sets: [
            {
                ...
                weight: 12.5,
                notes: "Easy to go too heavy on this one, use the tempo to make it burn rather than the weight itself. Connect with the chest."
            },
            {
                repLow: 10,
                repHi: 12,
        ...
        sets: [
            {
                ...
                weight: 25,
                notes: "Elbows pointed straight up toward the ceiling and locked in place"
            },
            {
                repLow: 11,
                repHi: 15,
